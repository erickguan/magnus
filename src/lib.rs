...
/// Initializes feature-gated Magnus integrations with the Ruby VM.
///
/// - Jiff timezone (`jiff-zoned`): defines `Jiff::TimeZone` and enables
///   Jiff-backed Ruby timezone names and Marshal restoration by registering
///   `Time.find_timezone`.
///
/// The code generated by [`macro@init`] calls this function before it
